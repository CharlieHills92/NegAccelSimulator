...
// Simulation OUTPUT 
string output_name="ELISE_H_AG31_j140_B2";  // Name (of the folder containing the results);
...
//parametri 
int numero_cicli = 18;                                 //iteration number
...
const int nscan=9;// number of simulations 
double current_density_scan[nscan]={100,110,120,130,140,150,160,170,180}; // extracted currents, A/m2
double V1_scan[nscan]={5, 5, 5 ,5, 5 ,5, 5, 5 ,5}; // grid 1 voltage (tipically EG)
double V2_scan[nscan]={33,33,33,33,33,33,33,33,33};// grid 2 voltage (tipically AG1/GG)
