...
// Atomic mass unit (kg)
#define MASS_U        1.660539040e-27 //NdH: updated the value at 2016-11-21 from http://physics.nist.gov/cgi-bin/cuu/Value?tukg which gives the 2014 CODATA recommended value.
